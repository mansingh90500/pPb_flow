...
process.RAGHUV0 = cms.EDAnalyzer("RaghuV0Ana",
    ...
    pTminTrk_ass_ks = cms.untracked.double(0.5),
    pTminTrk_ass_lm = cms.untracked.double(0.5),
    pTminTrk_trg = cms.untracked.vdouble(0.5),
    pTminTrk_trg_ks = cms.untracked.double(0.5),
    pTminTrk_trg_lm = cms.untracked.double(0.5),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('V0_test_IM_lowpT.root')
)
