...
process.RAGHUV0 = cms.EDAnalyzer("RaghuV0Ana",
    ...
    pTmaxTrk_ass = cms.untracked.vdouble(10.0),
    pTmaxTrk_ass_ks = cms.untracked.double(10.0),
    pTmaxTrk_ass_lm = cms.untracked.double(10.0),
    pTmaxTrk_trg = cms.untracked.vdouble(10.0),
    pTmaxTrk_trg_ks = cms.untracked.double(10.0),
    pTmaxTrk_trg_lm = cms.untracked.double(10.0),
    pTminTrk_ass = cms.untracked.vdouble(0.6),
    pTminTrk_ass_ks = cms.untracked.double(0.6),
    pTminTrk_ass_lm = cms.untracked.double(0.6),
    pTminTrk_trg = cms.untracked.vdouble(0.6),
    pTminTrk_trg_ks = cms.untracked.double(0.6),
    pTminTrk_trg_lm = cms.untracked.double(0.6),
