...
process.RAGHUV0 = cms.EDAnalyzer("RaghuV0Ana",
    ...
    mis_ks_range = cms.untracked.double(0.0138),
    ...
    ncentbin_binedge = cms.untracked.vdouble(
        0, 20, 40, 60, 80,
        120, 160
    ),
    nmass_ks_binedge = cms.untracked.vdouble(
        0.44, 0.475, 0.49, 0.495, 0.498,
        0.501, 0.506, 0.52, 0.56
    ),
    nmass_lm_binedge = cms.untracked.vdouble(
        1.08, 1.106, 1.112, 1.115, 1.117,
        1.12, 1.126, 1.143, 1.16
    ),
    ...
    pTmaxTrk_ass = cms.untracked.vdouble(12.0),
    pTmaxTrk_ass_ks = cms.untracked.double(12.0),
    pTmaxTrk_ass_lm = cms.untracked.double(12.0),
    pTmaxTrk_trg = cms.untracked.vdouble(12.0),
    pTmaxTrk_trg_ks = cms.untracked.double(12.0),
    pTmaxTrk_trg_lm = cms.untracked.double(12.0),
    pTminTrk_ass = cms.untracked.vdouble(0.2),
    pTminTrk_ass_ks = cms.untracked.double(0.2),
    pTminTrk_ass_lm = cms.untracked.double(0.2),
    pTminTrk_trg = cms.untracked.vdouble(0.2),
    pTminTrk_trg_ks = cms.untracked.double(0.2),
    pTminTrk_trg_lm = cms.untracked.double(0.2),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('V0_test_pt_invariantmass1.root')
)
