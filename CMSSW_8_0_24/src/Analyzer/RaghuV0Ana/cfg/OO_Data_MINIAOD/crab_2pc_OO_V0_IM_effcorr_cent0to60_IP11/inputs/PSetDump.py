...
process.RAGHUV0 = cms.EDAnalyzer("RaghuV0Ana",
    ...
    ncentbin_binedge = cms.untracked.vdouble(0, 20, 60, 120),
    ...
    pTmaxTrk_ass = cms.untracked.vdouble(8.0),
    pTmaxTrk_ass_ks = cms.untracked.double(8.0),
    pTmaxTrk_ass_lm = cms.untracked.double(8.0),
    pTmaxTrk_trg = cms.untracked.vdouble(8.0),
    pTmaxTrk_trg_ks = cms.untracked.double(8.0),
    pTmaxTrk_trg_lm = cms.untracked.double(8.0),
    pTminTrk_ass = cms.untracked.vdouble(0.7),
    pTminTrk_ass_ks = cms.untracked.double(0.7),
    pTminTrk_ass_lm = cms.untracked.double(0.7),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('V0_test_IM_wgt.root')
)
