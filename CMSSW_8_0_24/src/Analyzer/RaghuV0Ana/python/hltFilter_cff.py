...
hlthpt8 = HLTrigger.HLTfilters.hltHighLevel_cfi.hltHighLevel.clone()
hlthpt8.HLTPaths = ['HLT_PAFullTracks_Multiplicity110_HighPt8_v*']
hlthpt8.andOr = cms.bool(True)
hlthpt8.throw = cms.bool(False)
