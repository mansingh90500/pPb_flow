...
#options.inputFiles = '/store/user/singhm/pLHECoherent2sStarLightMC/RECOstep2StarLightUpsilonCoherent2s/240919_194130/0000/RECOsteo_1.root'
#options.inputFiles = '/store/user/singhm/pLHEqedStarLightMC/RECOstep2StarLightUpsilonQED/240919_090950/0000/RECOsteo_1.root'
#options.inputFiles = '/store/user/singhm/CMSSW_8_0_24/src/dir1/dir2/python/coh_1s/RECOstep.root'
#options.outputFile = 'onia2MuMuPAT_MC_exclusiveUpsilonQED_UPC.root'
options.inputFiles = 'file:RECOstep.root'
#options.outputFile = 'onia2MuMuPAT_MC_exclusiveUpsilon1sCoherent.root'
options.outputFile = 'onia2MuMuPAT_MC_exclusiveUpsilon1s.root'
...
if muonSelection == "Glb":
  ...
  process.onia1MuMuPatGlbGlb.higherPuritySelection = cms.string("("+highP+commonP1+")"+commonP2)
